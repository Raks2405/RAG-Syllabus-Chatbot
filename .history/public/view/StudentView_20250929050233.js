...
export class StudentView extends AbstractView {
  ...
  async extractPdfText(url) {
    ...
    // *** MODIFICATION: Using local worker file path ***
    // Ensure you have downloaded pdf.worker.min.js and placed it at this path!
    pdfjsLib.GlobalWorkerOptions.workerSrc = '/assets/pdf.worker.min.js';
    
    let pdf;
    try {
      // Keep the disableWorker flag as a safeguard against persistent errors
